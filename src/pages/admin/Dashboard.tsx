            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
                ...
                <CardContent className="pt-4">
                  <div className="h-80">
                    <ResponsiveContainer width="100%" height="100%">
                      <LineChart data={monthlySalesData} className="animate-fade-in">
              ...
              <Card className="col-span-1 hover-scale">
                ...
                <CardContent className="pt-4">
                  <div className="h-80">
                    <ResponsiveContainer width="100%" height="100%">
                      <BarChart data={topSellingBooks} layout="vertical" className="animate-fade-in">
                        <CartesianGrid strokeDasharray="3 3" />
                        <XAxis type="number" />
              ...
              <CardContent>
                <div className="overflow-x-auto">
                  <table className="w-full text-sm">
                    ...
                    <tbody>
                      <tr className="border-b animate-fade-in" style={{ animationDelay: "0ms" }}>
                      ...
                      <tr className="border-b animate-fade-in" style={{ animationDelay: "50ms" }}>
                      ...
                      <tr className="border-b animate-fade-in" style={{ animationDelay: "100ms" }}>
                      ...
                      <tr className="border-b animate-fade-in" style={{ animationDelay: "150ms" }}>
